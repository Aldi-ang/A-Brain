...
1. **What does "high end kind of apps" actually mean to him?** He's said it twice, never
   defined it. Could mean reliability, visual polish, feature depth, or enterprise-readiness
   — and each pulls the roadmap in a different direction. Worth asking early.
